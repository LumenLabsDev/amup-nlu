...
When actions are executed before the answer generation, you can easily use the action to manipulate the context and entities that are used to build the answers because they can be used as placeholders in the answer.
